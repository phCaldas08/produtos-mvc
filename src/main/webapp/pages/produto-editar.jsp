...
<!-- Diretiva para corrigir erro do put ao preencher com erro -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well">
					...
					<form:form modelAttribute="produto" action="${contextPath}/produto" method="put">
						...
						<div class="form-group">
							...
							<form:input type="text" path="nome" name="nome" id="nome" class="form-control" maxlength="50" size="50" />
							<font color="red">
						...
						<div class="form-group">
							...
							<form:input type="text" path="preco" name="preco" id="preco" class="form-control" maxlength="14" size="15" />
							<font color="red">
						...
						<div class="form-group">
							...
							<form:textarea id="mensagem" class="form-control" path="caracteristicas" name="caracteristicas" rows="4" cols="100"></form:textarea>
							<font color="red">
